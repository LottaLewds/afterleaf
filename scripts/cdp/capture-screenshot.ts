...
const outputPath = process.env.AFTERLEAF_CDP_SCREENSHOT_PATH ?? "/tmp/afterleaf-cdp.png";
...
try {
  ...
  const screenshot = await session.request<{data?: string}>("Page.captureScreenshot", {
