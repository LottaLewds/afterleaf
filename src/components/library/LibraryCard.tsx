  ...
  >
    <div
      class={[
        ...
        {
          "ring-2 ring-[#e85649] ring-offset-4 ring-offset-[#121918]": props.active && !props.multiSelected,
          "ring-2 ring-[#70a28b] ring-offset-4 ring-offset-[#121918]": Boolean(props.multiSelected),
        },
      ]}
    >
