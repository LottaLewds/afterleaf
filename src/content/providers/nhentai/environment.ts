...
export const nhentaiClientOptionsFromEnvironment = (): NhentaiClientOptions => {
  ...
  return {
    ...(cookie ? {cookie} : {}),
    ...(process.env.AFTERLEAF_FLARESOLVERR_URL
      ? {flaresolverrUrl: process.env.AFTERLEAF_FLARESOLVERR_URL}
      : {}),
    ...(process.env.AFTERLEAF_NHENTAI_USER_AGENT
      ? {userAgent: process.env.AFTERLEAF_NHENTAI_USER_AGENT}
      : {}),
  };
};
