...
export const SHELF_PREVIEW_TRANSLATION_SPEED = SHELF_PREVIEW_SPEED / SHELF_PREVIEW_PULL_END;

export const SHELF_PREVIEW_ROTATION_SPEED = SHELF_PREVIEW_SPEED / (1 - SHELF_PREVIEW_ROTATION_START);
